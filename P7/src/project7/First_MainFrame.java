...
public class First_MainFrame extends JFrame{
	public First_MainFrame(){
		setSize(500,400);
		setTitle("CGV");
		...
		button1.addActionListener(new ActionListener() { 						// 영화 예매 버튼 이벤트리스너
			...
			public void actionPerformed(ActionEvent arg0) {
				...
				new Second_TicketingFrame().show(); 									// ticketframe을 보여줌
				First_MainFrame.this.dispose();										// mainframe은 dispose함
			}
		});
		button2.addActionListener(new ActionListener() { 						// 예매 확인 버튼 이벤트 리스너
			...
			public void actionPerformed(ActionEvent e) {
				// TODO Auto-generated method stub
				new Fourth_CheckTicketFrame().show(); 									// checkTicketFrame 을 보여줌
				First_MainFrame.this.dispose(); 										// mainframe은 dispose해줌
			}
		});
